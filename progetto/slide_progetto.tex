...
\begin{frame}{Procedure di base - Procedure di alimentazione automatiche dai flussi di verifica}
    ...
    I dati ottenuti dal congteggio vengono inseriti nel sistema informativo, il processo di inserimento può essere reso più semplice e veloce dalla tecnologia, per esempio usando delle etichtte RFID (IoT) che comunicano al sistema la loro presenza.
